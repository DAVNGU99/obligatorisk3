...
class JavaSetToMengdeTest {
	...
	private JavaSetToMengde<Integer> tabellMedToElementer;
	private JavaSetToMengde<Integer> tabellMedFemElementer;
	private JavaSetToMengde<Integer> tomTabell;
	private JavaSetToMengde<Integer> tabellMedIngentingTilFelles;
	...
	void setUp() {
		...
		tomTabell = new JavaSetToMengde<Integer>();
		
		tabellMedToElementer = new JavaSetToMengde<Integer>();
		tabellMedToElementer.leggTil(5);
		tabellMedToElementer.leggTil(3);
		
		tabellMedFemElementer = new JavaSetToMengde<Integer>();
		...
		tabellMedIngentingTilFelles = new JavaSetToMengde<Integer>();

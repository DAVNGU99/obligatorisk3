...
class LenketMengdeTest {
	...
	private LenketMengde<Integer> tabellMedToElementer;
	private LenketMengde<Integer> tabellMedFemElementer;
	private LenketMengde<Integer> tomTabell;
	private LenketMengde<Integer> tabellMedIngentingTilFelles;

@BeforeEach
void setUp() {
	
	tomTabell = new LenketMengde<Integer>();
	
	tabellMedToElementer = new LenketMengde<Integer>();
		tabellMedToElementer.leggTil(5);
		tabellMedToElementer.leggTil(3);
	
	tabellMedFemElementer = new LenketMengde<Integer>();
	...
	tabellMedIngentingTilFelles = new LenketMengde<Integer>();
	...
	void erLik() {
		...
		tabellMedToElementer.leggTil(1);
		tabellMedToElementer.leggTil(2);
		assertFalse(tabellMedToElementer.erLik(tabellMedFemElementer));

		tabellMedToElementer.leggTil(4);

		assertTrue(tabellMedToElementer.erLik(tabellMedFemElementer));
